...
POS: Retorna una nueva lista (que no comparte memoria con la anterior) que tiene todos los elementos de la
	 lista original en orden Invertido, excluyendo el ultimo elemento.
	 La lista retornada no debera compartir memoria con la lista recibida ni debera modificarla.
...
POS: Elimina n-esimo elemento de la lista, empezando a contar desde el ultimo nodo.
	 Si n es mayor al largo de la lista, o menor a 1, la operacion no tendra efecto.
	 Esta operacion no debe recorrer la lista mas de una vez. No se pueden usar funciones auxiliares.
...
POS: Retorna una nueva lista (que no comparte memoria con la anterior) que contiene todos los elementos
	 ...
	 La lista retornada no debera compartir memoria con la lista recibida ni debera modificarla.
	 Se debera utilizar el algoritmo InsertionSort para ordenar los elementos.
...
POS: Retorna una nueva lista con todos los elementos de l1 y l2, incluyendo repetidos, ordenados en orden creciente.
	 ...
	 El ejercicio se debera resolver de forma iterativa.
...
POS: Retorna una nueva lista con todos los elementos de l1 y l2, incluyendo repetidos, ordenados en orden creciente.
	 La lista retornada no puede compartir memoria con las listas recibidas, y estas no pueden ser modificadas.
	 La funcion no debe recorrer l1 o l2 mas de una vez, y la lista resultado no debera recorrerse
	 El ejercicio se debera resolver de forma recursiva.
...
POS: Elimina todos los elementos de l que tienen al menos un duplicado.
	 Esta operacion se debe realizar en O(n), siendo n la cantidad de elementos en la lista.
...
/*
PRE: Recibe una lista simplemente encadenada
POS: Retorna si la lista es palindroma o no. En otras palabras, el primer elemento es igual al ultimo, el segundo
	 al penultimo, etc. (Se puede leer igual de los dos lados).
...
POS: modifica la lista l eliminando la primera ocurrencia de la secuencia (si existe).
	 ...
	 La lista secuencia no se debera modificar.
...
/*
PRE: recibe una lista simplemente encadenada
POS: mueve el nodo que se encuentra en la posicion inicial a la posicion final.
	 Las posiciones de la lista seran numeradas a partir del 1,
	 sindo esta la posicion del primer nodo y el largo de la lista la ultima posicion.
	 Si alguna de las posiciones no se encuentra dentro del rango
	 de la lista, esta no debe verse afectada.
